...
interface Drawable {
    val dims: Dims2
    fun draw(sb: SpriteBatch, width: Float, height: Float, x: Float, y: Float, rotation: Float, drawData: DrawState)
}

fun draw(sb: SpriteBatch, texture: TextureRegion, x: Float, y: Float, width: Float, height: Float, originX: Float = 0.0f,
